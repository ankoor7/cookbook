...
class RecipeIngredientsControllerTest < ActionController::TestCase
  ...
  test "should create recipe_ingredient" do
    assert_difference('RecipeIngredient.count') do
      post :create, recipe_ingredient: { amount: @recipe_ingredient.amount, ingredient_id: @recipe_ingredient.ingredient_id, recipe_id: @recipe_ingredient.recipe_id }
    end
  ...
  test "should update recipe_ingredient" do
    put :update, id: @recipe_ingredient, recipe_ingredient: { amount: @recipe_ingredient.amount, ingredient_id: @recipe_ingredient.ingredient_id, recipe_id: @recipe_ingredient.recipe_id }
    assert_redirected_to recipe_ingredient_path(assigns(:recipe_ingredient))
  end
